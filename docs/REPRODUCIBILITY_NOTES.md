...
- `scripts/run_robustness_by_lab_method.py` reproduce exactamente las filas y
  metricas leave-method-out del resultado final.
...
puede depender de detalles numericos de BLAS, CPU y versiones de
scikit-learn/numpy.
...
la regresion logistica balanceada sigue siendo el modelo seleccionado.

## Corrida optimizada

La corrida principal reportada se genero con:
